...
<body>
    <center>
        <div class="container">
            ...
            <form action="hasilUAS.php" method="POST">
                <div class="row">
                    <div class="col">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col">
                                        ...
                                        <div class="mb-3" align="left">
                                            ...
                                            <input type="text" class="form-control" id="exampleInputPassword1" placeholder="Cicilan" name="cicilan">
                                        </div>
                                        <div class="mb-3" align="left">
                                            <label for="exampleInputPassword1" class="form-label">Infaq</label>
                                            <input type="text" class="form-control" id="exampleInputPassword1" placeholder="infaq" name="infaq">
                                        </div>
